...
# MValencia,2.19.2023,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = str(input("What is the priority [Low, Medium, High]? - ")).strip()
    ...
    def input_task_to_remove():
        ...
        """
        # TODO: Add Code Here!
        task = str(input("Remove which tasks? ")).strip()
